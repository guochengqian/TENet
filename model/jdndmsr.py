...
class Net(nn.Module):
    def __init__(self,
        ...
        self.stem = nn.Sequential(common.ConvBlock(in_channels + noisy_channels, channels*4, 3,
                                  act='relu', bias=True),
                                  nn.ConvTranspose2d(channels*4, channels, 2, 2, 0), 
                                  nn.ReLU(True), 
                                  )
        ...
        self.out_branch = nn.Sequential(nn.ConvTranspose2d(channels, channels, 2, 2, 0),
                                        nn.ReLU(True),  
